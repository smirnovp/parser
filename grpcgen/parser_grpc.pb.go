...
type ParserServiceClient interface {
	GetData(ctx context.Context, in *ParserRequest, opts ...grpc.CallOption) (*ParserResponse, error)
}
...
type ParserServiceServer interface {
	GetData(context.Context, *ParserRequest) (*ParserResponse, error)
...
func (UnimplementedParserServiceServer) GetData(context.Context, *ParserRequest) (*ParserResponse, error) {
...
func _ParserService_GetData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ParserRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ParserServiceServer).GetData(ctx, in)
	}
...
var ParserService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetData",
			Handler:    _ParserService_GetData_Handler,
		},
	},
